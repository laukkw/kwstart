...
var (
    unknownCoder defaultCoder = defaultCoder{1, http.StatusInternalServerError, "An internal server error occurred", "https://github.com/rzry/kwstart/README.md"}
)
...
func Register(coder Coder) {
    if coder.Code() == 0 {
        panic("code `0` is reserved by `github.com/rzry/kwstart/errors` as unknownCode error code")
    }
...
func MustRegister(coder Coder) {
    if coder.Code() == 0 {
        panic("code '0' is reserved by 'github.com/rzry/kwstart/errors' as ErrUnknown error code")
    }
