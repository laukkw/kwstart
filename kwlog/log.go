...
// Package kwlog is a kwlog package used by TKE team.
package kwlog
...
import (
	...
	"github.com/laukkw/kwstart/kwlog/klog"
)
...
type InfoLogger interface {
	...
	// the kwlog line.  The key/value pairs can then be used to add additional
...
// Logger represents the ability to kwlog messages, both errors and not.
type Logger interface {
	...
	// verbosity level means a kwlog message is less important.  It's illegal to
	// pass a kwlog level less than zero.
	...
	// WithContext returns a copy of context in which the kwlog value is set.
	WithContext(ctx context.Context) context.Context

	// Flush calls the underlying Core's Sync method, flushing any buffered
	// kwlog entries. Applications should take care to call Sync before exiting.
	Flush()
}
...
// zapLogger is a logr.Logger that uses Zap to kwlog.
...
// NewLogger creates a new logr.Logger using the given Zap Logger to kwlog.
...
// ZapLogger used for other kwlog wrapper such as klog.
func ZapLogger() *zap.Logger {
	return std.zapLogger
}

// CheckIntLevel used for other kwlog wrapper such as klog which return if logging a
...
// Debug method output debug level kwlog.
...
// Debugf method output debug level kwlog.
...
// Debugw method output debug level kwlog.
...
// Info method output info level kwlog.
...
// Infof method output info level kwlog.
...
// Infow method output info level kwlog.
...
// Warn method output warning level kwlog.
...
// Warnf method output warning level kwlog.
...
// Warnw method output warning level kwlog.
...
// Error method output error level kwlog.
...
// Errorf method output error level kwlog.
...
// Errorw method output error level kwlog.
...
// Panic method output panic level kwlog and shutdown application.
...
// Panicf method output panic level kwlog and shutdown application.
...
// Panicw method output panic level kwlog.
...
// Fatal method output fatal level kwlog.
...
// Fatalf method output fatal level kwlog.
...
// Fatalw method output Fatalw level kwlog.
